...
.hero {
  padding: 140px 60px;
  background: linear-gradient(135deg, rgba(44, 95, 45, 0.7), rgba(151, 188, 98, 0.6)),
    url("/assets/images/header.png") center/cover;
  color: white;
  text-align: center;
  position: relative;
  overflow: hidden;
...
.hero::before {
  ...
  right: 0;
  bottom: 0;
  background: linear-gradient(45deg, rgba(249, 228, 183, 0.2), transparent);
  pointer-events: none;
}
